    ...
    <div class="pagecart">
        ...
        <div >
            <div id="cnxhTitle " class="recomm_mod_title">
                <span class="recomm_mod_title_text">
                    {{bottomtext}}
                </span>
            </div>
...
export default {
  ...
  created() {
    let that = this;
    let url = "http://127.0.0.1:5500/dist/data/cart.json";
    axios
      .get(url)
...
.shopcart_mod_title 
.shopcart_mod_title_text:after, .shopcart_mod_title 
...
.recomm_mod_title 
.recomm_mod_title_text:after, .recomm_mod_title 
.recomm_mod_title_text:before {
    content: "";
    position: absolute;
    top: 50%;
    margin-top: -2px;
...
.mod_recommend_v2 
.mod_tag .tag_img, .mod_recommend_v2 .mod_tag img {
    display: inline-block;
    height: 100%;
    margin-right: 1px;
}
